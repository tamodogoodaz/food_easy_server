...
exports.totalApi = router => {
  ...
  router.post(
    "/addNewShop",
    uploads.uploads.array("imgShop", 12),
    apiC.addNewShop
  )
  router.post(
    "/addNewFood",
    uploads.uploads.array("imgFood", 12),
    apiC.addNewFood
  )
  router.delete("/deleteFood/:id_food_one", apiC.deleteFoodData)
  router.delete("/deleteShop/:id_shop", apiC.deleteShopDB)
  router.param("id_food", apiC.idParamFood)
  router.param("id_food_one", apiC.foodFindOne)
